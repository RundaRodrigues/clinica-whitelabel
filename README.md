# Clínica Médica — modelo white label

Modelo white label para clínicas multiespecialidades. Calmo, preciso, orientado a agendamento.
...
**Seções da página:** hero com cartão de agendamento, especialidades, como funciona, convênios, números, corpo clínico, depoimentos, dúvidas e formulário.
...
Sistema de design adaptado (não copiado) de **cal + stripe**, via
