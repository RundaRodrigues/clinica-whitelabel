# Clinica Medica — modelo white label

Modelo white label para clinicas multiespecialidades. Calmo, preciso, orientado a agendamento.
...
**Secoes da pagina:** hero com cartao de agendamento, especialidades, como funciona, convenios, numeros, corpo clinico, depoimentos, FAQ, formulario.
...
Sistema de design adaptado (nao copiado) de **cal + stripe**, via
